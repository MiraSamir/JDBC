...
public interface IDBMS {
	...
	public LinkedHashMap<String, ArrayList<String>> selectDistinctFromTable(String tableName, ArrayList<String> columns,
			String[] where) throws DBMSException, Exception;
	 ...
	 * @throws Exception
	 */
	public void alterAdd(String tableName, ArrayList<String> columns, ArrayList<String> types)
	 ...
	 * @throws Exception
	 */
	public void alterDrop(String tableName, ArrayList<String> columns) throws DBMSException, Exception;
}
